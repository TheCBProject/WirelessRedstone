...
public class TriangTexManager implements IIconRegister {
    ...
    static {
        ...
        for (int i = 0; i < textures.length; i++) {
            textures[i] = new ManagedTextureFX(16, "wrcbe:triang_" + i);
    ...
    public void registerIcons(TextureMap textureMap) {
        texRing = TextureUtils.loadTextureColours(new ResourceLocation("wrcbe", "textures/items/triang_ring.png"));
        texGrad = TextureUtils.loadTextureColours(new ResourceLocation("wrcbe", "textures/items/triang_grad.png"));
        processTexture(-1, 0);
    }
